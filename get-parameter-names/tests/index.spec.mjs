...
import { getParameterNames } from '../src/index.js';
...
describe('function tests', () => {
    it('test1', () => {
        ...
        expect(getParameterNames(test1)).toEqual(['a', 'b', 'c']);
    });
    ...
    it('test2', () => {
        ...
        expect(getParameterNames(test2)).toEqual(['a', 'b', 'c']);
    });
    ...
    it('test3', () => {
        ...
        expect(getParameterNames(test3)).toEqual(['a', 'b', 'c']);
    });
    ...
    it('test4', () => {
        ...
        expect(getParameterNames(test4)).toEqual(['a', 'b', 'c', 'd']);
    });
    ...
    it('test5', () => {
        ...
        expect(getParameterNames(test5)).toEqual(['a', 'b', 'c']);
    });
    ...
    it('test6', () => {
        ...
        expect(getParameterNames(test6)).toEqual(['a']);
    });
     ...
     */
        ...
        expect(getParameterNames(test7)).toEqual(['a', 'b', 'c']);
    });

    it('test8', () => {
        function test8(a, b, c) {}

        expect(getParameterNames(test8)).toEqual(['a', 'b', 'c']);
    });

    it('test9', () => {
        function π9(ƒ, µ) {}

        expect(getParameterNames(π9)).toEqual(['ƒ', 'µ']);
    });

    it('test10', () => {
        function test9() {}
        expect(getParameterNames(test9)).toEqual([]);
    });

    it('supports ES2015 fat arrow functions with parens', () => {
        var f = '(a,b) => a + b';

        expect(getParameterNames(f)).toEqual(['a', 'b']);
    });

    it('supports ES2015 fat arrow functions without parens', () => {
        var f = 'a => a + 2';
        expect(getParameterNames(f)).toEqual(['a']);
    });

    it('supports function with name followed by double opening paren', () => {
        var f = 'function func(()=>x) {}';
        expect(getParameterNames(f)).toEqual(['']);
    });
    ...
    it('supports ES2015 fat arrow function without parens test1.', () => {
        ...
        expect(getParameterNames(f)).toEqual(['c']);
    });
    ...
    it('supports ES2015 fat arrow function without parens test3.', () => {
        ...
        expect(getParameterNames(f)).toEqual(['items']);
    });
    ...
    it('ignores ES2015 default params', () => {
        ...
        expect(getParameterNames(f11)).toEqual(['a', 'b']);
    });
    ...
    it('supports ES2015 default params with fat arrow function with multiple arguments', () => {
        ...
        expect(getParameterNames(f)).toEqual(['a', 'b', 'c']);
    });
    ...
    it('ES2015 default params with var re-assignment to an argument like value', () => {
        ...
        expect(getParameterNames(f)).toEqual(['id']);
    });
    ...
    it('ignores ES2016 async keyword test 4', () => {
        ...
        expect(getParameterNames(f)).toEqual(['async', 'b']);
    });
    ...
    it('ignores ES2016 async keyword test 7', () => {
        ...
        expect(getParameterNames(f)).toEqual(['async']);
    });
    ...
    describe('ES2016 Class', () => {
        ...
        it('static get before constructor', () => {
            ...
            expect(getParameterNames(Cat)).toEqual([]);
        });
        ...
        it('class with static get after constructor', () => {
            ...
            expect(getParameterNames(Cat)).toEqual(['a', 'b']);
        });
        ...
        it('class constructor with inheritance', () => {
            ...
            class Cat extends Animal {
                constructor(a, b) {
                    super();
                    expect(getParameterNames(this.constructor)).toEqual(['a', 'b']);
                }
            }
            expect(getParameterNames(Cat)).toEqual(['a', 'b']);
        });
